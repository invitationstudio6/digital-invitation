...
const LUNA_CATEGORIES = [
    {
        ...
        palette: { bg: "#F5EDE3", accent: "#C4A882", text: "#3E2518", muted: "#8A6E5E", gradient: "linear-gradient(135deg, #F5EDE3, #EDE3D5, #E8D8C8)" },
    ...
    },
    {
        ...
        palette: { bg: "#FBF0F3", accent: "#C88A9A", text: "#4A2A32", muted: "#8A6A72", gradient: "linear-gradient(135deg, #FBF0F3, #F5E6EB, #F0DCE3)" },
        typography: { heading: "'Playfair Display', serif", body: "'Cormorant Garamond', serif", accent: "'Great Vibes', cursive" },
    ...
    },
    {
        ...
        palette: { bg: "#F5EDE0", accent: "#C89860", text: "#3E2518", muted: "#8A6E5E", gradient: "linear-gradient(135deg, #F5EDE0, #EDE4D5, #E8D8C0)" },
        typography: { heading: "'Playfair Display', serif", body: "'Cormorant Garamond', serif", accent: "'Great Vibes', cursive" },
    ...
    },
    {
        ...
        palette: { bg: "#FFF8F0", accent: "#E8A870", text: "#3E2518", muted: "#8A6E5E", gradient: "linear-gradient(135deg, #FFF8F0, #FFF0E2, #FFE8D0)" },
    ...
    },
    {
        ...
        palette: { bg: "#F4F6F8", accent: "#6080A0", text: "#1A2A3A", muted: "#6A7A8A", gradient: "linear-gradient(135deg, #F4F6F8, #E8ECF0, #DCE4EC)" },
    ...
    },
    {
        ...
        palette: { bg: "#FFF8F5", accent: "#E8A090", text: "#3E2518", muted: "#8A6E5E", gradient: "linear-gradient(135deg, #FFF8F5, #FFF0EA, #FFE8E0)" },
        typography: { heading: "'Playfair Display', serif", body: "'Cormorant Garamond', serif", accent: "'Great Vibes', cursive" },
    ...
    },
    {
        ...
        palette: { bg: "#F0F2F4", accent: "#506070", text: "#1A2028", muted: "#6A7078", gradient: "linear-gradient(135deg, #F0F2F4, #E4E8EC, #D8DEE4)" },
